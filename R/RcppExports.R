...
#' @importFrom Rcpp sourceCpp
#' @export
get_moments_cpp_skinny <- function(prob, mu_gamma, mu_alpha, anc, cardanc) {
    .Call('_lotR_get_moments_cpp_skinny', PACKAGE = 'lotR', prob, mu_gamma, mu_alpha, anc, cardanc)
}
...
#' @importFrom Rcpp sourceCpp
#' @export
update_rZ <- function(psi, g_psi, phi, g_phi, X, E_beta, E_eta, E_beta_sq, E_eta_sq, v_lookup) {
    .Call('_lotR_update_rZ', PACKAGE = 'lotR', psi, g_psi, phi, g_phi, X, E_beta, E_eta, E_beta_sq, E_eta_sq, v_lookup)
}
...
#' @importFrom Rcpp sourceCpp
#' @export
update_gamma_subid <- function(u, g_psi, rmat, tau_2_t_u, h_pau, levels, E_beta, E_zeta_u, X, subject_ids, v_lookup) {
    .Call('_lotR_update_gamma_subid', PACKAGE = 'lotR', u, g_psi, rmat, tau_2_t_u, h_pau, levels, E_beta, E_zeta_u, X, subject_ids, v_lookup)
}
...
#' @importFrom Rcpp sourceCpp
#' @export
update_alpha_subid <- function(u, g_phi, rmat, tau_1_t_u, h_pau, levels, E_eta, E_xi_u, subject_ids, v_lookup) {
    .Call('_lotR_update_alpha_subid', PACKAGE = 'lotR', u, g_phi, rmat, tau_1_t_u, h_pau, levels, E_eta, E_xi_u, subject_ids, v_lookup)
}
...
#' @importFrom Rcpp sourceCpp
#' @export
get_line1_2_subid <- function(psi, g_psi, phi, g_phi, rmat, E_beta, E_beta_sq, E_eta, E_eta_sq, X, v_lookup) {
    .Call('_lotR_get_line1_2_subid', PACKAGE = 'lotR', psi, g_psi, phi, g_phi, rmat, E_beta, E_beta_sq, E_eta, E_eta_sq, X, v_lookup)
}
